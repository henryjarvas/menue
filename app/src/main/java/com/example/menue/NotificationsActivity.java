...
public class NotificationsActivity extends AppCompatActivity {
    ...
    private static final String NOTIFICATIONS_LIST_URL= "http://192.168.1.178:8080/mosaver/get_Notified.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new NotificationsAdapter(this,mData);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < users.length(); i++) {
                                ...
                                NotificationsModel notificationsModel = new NotificationsModel(id, fullname, status, amount, saving_date, balance);




                                mData.add(notificationsModel);
                               /* error_message.setVisibility(View.GONE);*/

                            }
                            adapter = new NotificationsAdapter(NotificationsActivity.this, mData);
                            recyclerView.setAdapter(adapter);
...
//                            login.setVisibility(View.VISIBLE);
                            Toast.makeText(NotificationsActivity.this, "failed to save........ "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        loading.dismiss();
//                        login.setVisibility(View.VISIBLE);
                        Toast.makeText(NotificationsActivity.this, "Saving continues to  failllllllllllll"+error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
