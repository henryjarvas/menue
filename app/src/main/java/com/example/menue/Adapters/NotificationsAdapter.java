...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.NotificationsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NotificationsViewHolder holder, final int position) {
       ...
       /* if (holder.status_holder.equals("withdraw")){
    ...
    public class NotificationsViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name_holder,status_holder,amount_holder,saving_date_holder,balance_holder;
        CardView notifications;
        TextView fullname,status,amount,saving_date,balance;
